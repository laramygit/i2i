...
export class JobSeekerComponent implements OnInit {
  ...
  saveJobSeeker() {
   ...
   var selectedSkillId = this.jobSeekerForm.value.skills.map((v, i) => v ? this.skills[i].id : null).filter(v => v !== null);
   var selectedSkillIdsArray = selectedSkillId.toString().split(',');
   var skillsArray = [];
